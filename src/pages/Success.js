  ...
  return (
    <div ref={containerRef} className="fade-up" style={{ textAlign:'center', padding:'20px 0', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{
        ...
        boxShadow:'0 8px 24px rgba(212,83,126,.35)',
      }}>✓</div>
      ...
      <div style={{ display:'flex', gap:8, marginBottom:16 }}>
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <rect x="3" y="4" width="18" height="18" rx="2" stroke="var(--p600)" strokeWidth="1.8"/>
            <path d="M16 2v4M8 2v4M3 10h18" stroke="var(--p600)" strokeWidth="1.8" strokeLinecap="round"/>
            <path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01M16 18h.01" stroke="var(--p600)" strokeWidth="2" strokeLinecap="round"/>
          </svg>
          Google Calendar
        </a>
        <button
          ...
          style={{
            ...
            padding:'11px 12px', fontSize:13, fontWeight:500,
            background:'#fff', border:'1.5px solid var(--p200)',
            borderRadius:99, color:'var(--p700)', cursor:'pointer',
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="none" stroke="var(--p400)" strokeWidth="1.5"/>
            <rect x="3" y="4" width="18" height="18" rx="2" stroke="var(--p600)" strokeWidth="1.8"/>
            <path d="M16 2v4M8 2v4M3 10h18" stroke="var(--p600)" strokeWidth="1.8" strokeLinecap="round"/>
          </svg>
          Apple / iCal
